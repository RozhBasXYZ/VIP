...
echo -e "\n cloning github repository -> 'vip' ...\n"
git clone https://github.com/RozhBasXYZ/VIP
echo -e "\n install module and requirements ...\n"
cd VIP && python3.10 -m pip install --upgrade pip && python3.10 -m pip install wheel && python3.10 -m pip install -r requirements.txt
